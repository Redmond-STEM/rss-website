const HomePage = () => {
  ...
  return (
    <div>
      <head>
        <link rel='stylesheet' href="https://fonts.google.com/specimen/Gabarito"/>
      ...
      <div id="courses_offered">
        <h4 id="courses_title">
          Learning for every age group & subject
        </h4>
...
// <><><><div id='title'>
    ...
    //       just that, ensuring the child continues to enjoy the subject even after the course has ended.
    //     </p>
    //   </div></><div id='inspirational_quote'>
    //     <h4>
